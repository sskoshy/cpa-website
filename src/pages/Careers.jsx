...
function Careers() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-blue-800 to-sky-700 pt-16 pb-28 relative text-white">
      {/* Decorative glows (non-interactive) */}
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map(job => (
            <div
              key={job.title}
              className="bg-white/80 backdrop-blur rounded-2xl border border-white/60 shadow hover:shadow-lg hover:translate-y-[-2px] transition text-slate-900"
            >
              {/* Card header */}
              <div className="p-6">
                ...
                <p className="text-slate-800 text-sm leading-relaxed">{job.desc}</p>
        ...
        {/* Back/Next with clear labels (site-wide consistency) */}
        <div className="mt-12">
        ...
        >
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-lg p-6">
            <div className="flex items-start justify-between mb-4">
              <h3 id="apply-title" className="text-xl font-semibold text-slate-900">
                Apply for {role}
              </h3>
              <button
                onClick={closeApply}
            ...
            <form className="space-y-4" onSubmit={submitApply}>
              ...
              <div className="mt-4 flex items-center justify-end gap-3">
                <button type="button" onClick={closeApply} className="px-4 py-2 rounded border border-slate-300 hover:bg-slate-50">
                  Cancel
                </button>
                <button type="submit" className="px-4 py-2 rounded bg-sky-800 text-white hover:bg-sky-900">
                  Submit Application
                </button>
              </div>
            </form>
